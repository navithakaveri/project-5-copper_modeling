...
data=pd.read_csv(r"D:\youtube project\coper_model\coper (1).csv")
...
def ml():
    ...
    with tab1:   
     ...
     # Define the widgets for user input
        ...
        if submit_button and flag==0:
            ...
            with open(r"coper_model/model.pkl", 'rb') as file:
                
                loaded_model = pickle.load(file)
            with open(r"coper_model/scaler.pkl", 'rb') as f:
                
                scaler_loaded = pickle.load(f)

            with open(r"coper_model/t.pkl", 'rb') as f:
                t_loaded = pickle.load(f)

            with open(r"coper_model/s.pkl", 'rb') as f:
    ...
    with tab2: 
        ...
        if csubmit_button and cflag==0:
            import pickle
            with open(r"coper_model/clsmodel.pkl", 'rb') as file:
                cloaded_model = pickle.load(file)

            with open(r"coper_model/cscaler.pkl", 'rb') as f:
                cscaler_loaded = pickle.load(f)

            with open(r"coper_model/ct.pkl", 'rb') as f:
            ...
            new_pred = cloaded_model.predict(new_sample1)
            if new_pred==1:
